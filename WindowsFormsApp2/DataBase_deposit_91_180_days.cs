...
{
    public partial class DataBase_deposit_91_180_days : Form
    {
        public DataBase_deposit_91_180_days()
        {
            InitializeComponent();
        ...
        private void LoadData() // вывод базы данных в DataGridView 
        {
            ...
            myConnection.Open();
            string query = "SELECT * FROM deposit_91_180_day ORDER BY percent";
        ...
        {
            MySqlConnection myConnection = new MySqlConnection("server = localhost; port = 3306;username = root; password = root;database = banks");
            MySqlCommand command_delete = new MySqlCommand("DELETE FROM `deposit_91_180_day` WHERE `Name` = @Name", myConnection);
        ...
        {
            MySqlConnection myConnection = new MySqlConnection("server = localhost; port = 3306;username = root; password = root;database = banks");
            MySqlCommand command = new MySqlCommand("INSERT INTO `deposit_91_180_day` (`Name`, `Status`, `Percent`) VALUES (@Name, @Status, @Percent)", myConnection);
